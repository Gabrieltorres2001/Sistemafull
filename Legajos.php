...
<html><head>
    ...
    <title>SISTEMAPLUS - Legajos</title>
	...
	<script src="js/funcioneslegajos.js"></script>
    ...
    <link href="css/legajos.css" rel="stylesheet"> 	
	<!-- de EDITABLEGRID-->
...
<script src="js/select2.js"></script>
  ...
  <body>
    ...
    <?php if ((login_check($mysqli) == true) && (formulario_habilitado("Legajos") == true)) : ?>   
	<?php echo upperMenu('Legajos') ?>
...
<div id="agregarItemAlComprobante">
	<div style="position:absolute;
			  ...
			  border-color:#000;
			  background-color:#30F;">
		<label style="font-size:1.45em; font-weight:normal; color:#FFF">Buscar y agregar ítem al legajo</label>
		<div style="position:absolute;
				  left:670px;
				  top:0px;
