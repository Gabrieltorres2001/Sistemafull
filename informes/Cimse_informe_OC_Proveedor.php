...
<table border="0" {border-collapse: collapse;}>
	...
	<tr>
		<td rowspan="2" colspan="5" style="font-size:1em; text-align: left">Por favor, realizar la factura a nombre de CENTRO DE INSTRUMENTACION METROLOGIA Y SERVICIOS PATAGONIA SRL, Responsable Inscripto, CUIT 30-71224403-4, domicilio legal: Lote 8, Manzana “C”, Bº San Cristobal, Valentina Sur-(8300) Neuquén Capital - Neuquén. </td>
	</tr>
</table>
<table border="0" {border-collapse: collapse;}>
	<tr>
		<td width="75%"  style="font-size:1em; text-align: left">Enviarlos a: Ver notas. </td>	
	</tr>
</table>
<table border="0" {border-collapse: collapse;}>
	<tr>
...
<table border="0" {border-collapse: collapse;}>
	<tr>				
		...
		<td width="25%" style="font-size:1em; text-align: center" rowspan="3"><img src="../images/Presupuesto/Eduardo.png" width="100" height="60"></td>
	</tr>
</table>
</br>
<table border="0" {border-collapse: collapse;}>
	<tr>
		...
		<td rowspan="2" width="25%" style="font-size:1em; text-align: center; vertical-align: bottom">Eduardo Arrausi</td>
	</tr>
</table>
<table border="0" {border-collapse: collapse;}>
	<tr>
