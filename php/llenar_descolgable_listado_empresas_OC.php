<?php
	...
	//if(!$result = mysqli_query($conexion_sp, "select IdContacto,Organizacion,NombreCompleto from contactos ORDER BY Organizacion asc")) die("Problemas con la consulta");
	...
	echo"<input type='button' id='listoNuevaOC' value='Agregar'>";
