...
//generamos la consulta
   if(!$result = mysqli_query($conexion_sp, "select NumeroComprobante,FechaComprobante,NonmbreEmpresa,IdComprobante, NumeroComprobante02 from comprobantes where TipoComprobante=14 ORDER BY IdComprobante desc")) die("Problemas con la consulta1");
 
echo"<input type='button' id='listarTodos' value='Todos' Disabled>";
echo"<input type='button' id='listarMios' value='Mios'>";
echo"<br>";	
echo"<ul class='nav navbar-nav'>";
echo"<li>  Recibos ya realizados:  </li>";
echo"</ul>";
echo "<br>";
echo "<table class='display' id='tablaRecibosRealizados'>";  
echo "<tr>";  
echo "<th width='55'>Nº Id (Impreso)</th>";  
