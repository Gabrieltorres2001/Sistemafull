...
//generamos la consulta
   if(!$result = mysqli_query($conexion_sp, "select idLegajo, idComprobante from detallelegajos where tipoComprobante=9 ORDER BY IdComprobante desc")) die("Problemas con la consulta1");
...
echo"<input type='button' id='listarOCs' value='OCs' Disabled>";
echo"<br>";
echo"<ul class='nav navbar-nav'>";
echo"<li>  Legajos ya realizados filtrados por OC:  </li>";
echo"</ul>";
echo "<br>";
