...
//grabo EL VALOR DE la condicion de pago EN LA TABLA DE contacto
	if(!$resultCP = mysqli_query($conexion_sp, "update organizaciones set CondDePago=".$_REQUEST['condpago']." where id = '".$regContEmp['idOrganizacion']."'")) die("Problemas con la consulta contactos Organizacion"); 
