...
//generamos la consulta
   if(!$result = mysqli_query($conexion_sp, "select NumeroComprobante,FechaComprobante,NonmbreEmpresa,IdComprobante, NumeroComprobante02 from comprobantes where TipoComprobante=3 and Confecciono='".$_REQUEST['sesses']."' ORDER BY IdComprobante desc")) die("Problemas con la consulta1");
