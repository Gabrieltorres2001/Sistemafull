...
//generamos la consulta
   if(!$resultComprobante = mysqli_query($conexion_sp, "select NumeroComprobante,FechaComprobante,NonmbreEmpresa from comprobantes where TipoComprobante=3 ORDER BY IdComprobante desc limit 1")) die("Problemas con la consulta1");
