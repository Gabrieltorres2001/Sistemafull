...
//generamos la consulta
   if(!$result = mysqli_query($conexion_sp, "select idLegajo, idComprobante from detallelegajos where tipoComprobante=3 ORDER BY IdComprobante desc")) die("Problemas con la consulta1");
	
echo"<li>  Filtrar por:  </li>";
echo"<input type='button' id='listarPresupuestos' value='Presupuestos'>";
echo"<input type='button' id='listarRemitos' value='Remitos' Disabled>";
echo"<input type='button' id='listarOCs' value='OCs'>";
echo"<br>";
echo"<ul class='nav navbar-nav'>";
echo"<li>  Legajos ya realizados filtrados por remito:  </li>";
echo"</ul>";
echo "<br>";
