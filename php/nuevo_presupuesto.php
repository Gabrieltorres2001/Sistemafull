...
//generamos la consulta de buscar proximo numero de Presupuesto
	...
	if(!$resultProxPresupuesto = mysqli_query($conexion_sp, "select max(cast(NumeroComprobante as unsigned)) from comprobantes where TipoComprobante='5' limit 1")){
