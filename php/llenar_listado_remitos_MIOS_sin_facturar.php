...
//generamos la consulta
   if(!$result = mysqli_query($conexion_sp, "select NumeroComprobante,FechaComprobante,NonmbreEmpresa,IdComprobante, NumeroComprobante02 from comprobantes where TipoComprobante=3 and Confecciono='".$_REQUEST['sesses']."' and (UsuarioModificacion is null or UsuarioModificacion='') ORDER BY IdComprobante desc")) die("Problemas con la consulta1");

echo"<input type='button' id='listarTodos' value='Todos'>";
echo"<input type='button' id='listarMios' value='Mios' Disabled>";
echo"<br>";	
echo"<ul class='nav navbar-nav'>";
echo"<li>  Remitos MIOS ya realizados:  </li>";
echo"</ul>";
echo "<br>";
