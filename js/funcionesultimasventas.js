...
var conexion1;
function llenarListadoProveedores(){
  conexion1=new XMLHttpRequest(); 
  conexion1.onreadystatechange = procesarEventos1;
  var aleatorio=Math.random();
  conexion1.open('GET','./php/llenar_listado_provs_ventas.php?rnadom='+aleatorio, true);
  conexion1.send();
}
...
function informeDeudoresPDF(){
		...
		var aleatorio=Math.random();
		window.open('./informes/Informe.php?&rnadom='+aleatorio+"&tipoInforme=Deudores", true);
		conexion13.send();	
}
