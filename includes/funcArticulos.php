...
function llenar_acciones_articulos($estaSesion){
	//Creamos la conexión
	include_once 'includes/sp_connect.php';
	...
	$conexion_db=mysqli_connect(HOST,USER,PASSWORD,DATABASE) or
		...
		if(!$permisoModificar = mysqli_query($conexion_db, "select PuedeModificarArticulos from members where id='".$estaSesion."' limit 1")) die("Problemas con la consultamembers");
