...
if (isset($_POST['username'], $_POST['email'], $_POST['p'])) {
   ...
   // Verifica el correo electrónico existente.  
    ...
    if (empty($error_msg)) {
        ...
        if ($insert_stmt = $mysqli->prepare("INSERT INTO members (username, email, password, salt, Nombre, Foto) VALUES (?, ?, ?, ?, ?, 'images/perfil/hombre.jpg')")) {
            $insert_stmt->bind_param('sssss', $username, $email, $password, $random_salt, $nombre);
