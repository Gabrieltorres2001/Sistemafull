...
<html><head>
    ...
    <title>SISTEMAPLUS - Remitos sin facturar</title>
  ...
  <script type="text/javascript" src="js/jquery.min.js"></script>
	...
	<script src="js/funcionesRemitosSinFactura.js"></script>
...
<script src="js/select2.js"></script>
  ...
  <body>
	...
	<?php echo upperMenu('Remitos sin facturar') ?>
...
<div id="informeFactura">

</div> <!-- /informeFactura -->

<div id="resultadoFacturaEmitida">

</div> <!-- /resultadoFacturaEmitida -->
