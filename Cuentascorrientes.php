...
<html><head>
    ...
    <title>SISTEMAPLUS - Cuentas Corrientes</title>
	...
	<script src="js/funcionescuentasc.js"></script>
	<!-- scripts 	-->
    ...
    <link href="css/cuentasc.css" rel="stylesheet"> 
	<!-- de EDITABLEGRID-->
...
<body>  
	...
	<?php echo upperMenu('CuentasCorrientes') ?>
